...
### `> Fullstack Engineer in Progress` · `IBMEC RJ` · `Rio de Janeiro 🇧🇷`

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&pause=1000&color=00D9FF&center=true&vCenter=true&width=500&lines=JavaScript+%2B+Java+Developer;Frontend+%26+Backend+Explorer;Building+the+future%2C+one+commit+at+a+time)](https://git.io/typing-svg)
...
education:  "Engenharia de Software @ IBMEC RJ — 2º Período"
...
```json
{
  ...
  "learning":  ["React", "Spring Boot", "REST APIs"],
}
```
...
```
// "Code is not just instructions for machines — it's a language to shape the world."
```
